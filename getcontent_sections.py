...
info_pages = [x for _, x in all_content.items() if (x.contentType == "section")]

info_pages_first_titles = [page.title for page in info_pages]

pprint(sorted(info_pages_first_titles, key=len))
